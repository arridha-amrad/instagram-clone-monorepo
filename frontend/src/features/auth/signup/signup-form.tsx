...
export default function SignupForm() {
  ...
  const onSubmit = async ({ email, fullName, password, username }: TSignupSchema) => {
    setLoading(true);
    setError("")
    try {
      await authClient.signUp.email(
        ...
        {
          onSuccess: () => {
            setMessage(`An email has been sent to ${email}. Please follow to verify your account`)
            reset()
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <FieldGroup>
              ...
              <Field>
                ...
                <Input id="username" type="text" placeholder="m@example.com" {...register("username")} />
                {errors.username && (
              ...
              <Field>
                ...
                {(errors.confirmPassword || errors.password) ? (
                  <FieldError errors={[{ message: errors?.password?.message || errors?.confirmPassword?.message }]} />
                ) : (
                  <FieldDescription>
